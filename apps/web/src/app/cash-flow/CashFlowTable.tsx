...
import { fmt, COLORS } from "./types";
import type { DailyCashReport, CashFlowStatement, CashFlowSection } from "./types";

// --- 자금 일보 ---

export interface DailyCashViewProps {
  data: DailyCashReport;
}

export function DailyCashView({ data }: DailyCashViewProps) {
